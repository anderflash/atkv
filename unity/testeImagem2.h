...
/* TESTES DE LEITURA DE VÁRIOS TIPOS DE ARQUIVOS POR UMA FUNÇÃO */
void testLerImagem()
{
  lerImagem(AT_JPEG, "teste.jpg");
  lerImagem(AT_PNG, "teste.png");
  lerImagem(AT_TIFF, "teste.tiff");
  lerImagem(AT_GIF, "teste.gif");
}
